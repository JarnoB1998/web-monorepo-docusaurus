...
Maak een nieuw project aan met de naam `uitvinders` en plaats de onderstaande gegevens in een TypeScript-bestand.
...
3. Maak een array met daarin alle geboortejaren van de uitvinders
   ...
   **Verwachte uitkomst:**
   ...
   ```typescript
   [1879, 1643, 1564, 1867, 1571, 1473, 1858, 1898, 1815, 1855, 1878, 1847]
   ```
