...
Maak een nieuw VITE project `verander-tekst`. Je kan ook vertrekken van het [starterproject](/exercise-files/frontend/verander-tekst/starter.zip) met de HTML en CSS voor deze oefening.
