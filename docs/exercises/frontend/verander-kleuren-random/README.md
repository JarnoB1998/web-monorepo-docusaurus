...
Maak een nieuw VITE project `verander-kleuren-random`. Je kan ook vertrekken van het [starterproject](/exercises/frontend/verander-kleuren-random/starter.zip) met de HTML en CSS voor deze oefening.
