...
Download het <a href="/exercise-files/node-typescript/async-test/starter.zip">starter</a> project. Dit project bevat een `async.ts` module. Schrijf de volgende testen:
