...
Download het <a href="/exercise-files/node-typescript/math-test/starter.zip">starter</a> project. Dit project bevat een `math.ts` module. Schrijf de volgende testen:
